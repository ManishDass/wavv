...
const RegisterOrSignInPage = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-screen overflow-hidden test bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.2),rgba(0,0,0,0.7))] font-sans'>
      ...
      <p className='text-md text-white mb-8 mx-6 text-center font-santoshi-light'>Spotify is a proprietary Swedish audio streaming and media services provider </p>
